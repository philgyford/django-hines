...
class BlogDetailViewTestCase(ViewTestCase):
    ...
    def test_response_200(self):
        ...
        response = views.BlogDetailView.as_view()(self.request, blog_slug="my-blog")
        self.assertEqual(response.status_code, 200)

    def test_response_404(self):
        "It should raise 404 if there's no Blog with that slug."
        with self.assertRaises(Http404):
            views.BlogDetailView.as_view()(self.request, blog_slug="other-blog")
...
class BlogArchiveViewTestCase(ViewTestCase):
    ...
    def test_response_200(self):
        "It should respond with 200."
        response = views.BlogArchiveView.as_view()(self.request, blog_slug="my-blog")
        self.assertEqual(response.status_code, 200)

    def test_response_404(self):
        "It should raise 404 if there's no Blog with that slug."
        with self.assertRaises(Http404):
            views.BlogArchiveView.as_view()(self.request, blog_slug="other-blog")
...
class BlogTagDetailViewTestCase(ViewTestCase):
    ...
    def test_templates(self):
        ...
        self.assertEqual(response.template_name[0], "weblogs/blog_tag_detail.html")
...
class BlogTagListViewTestCase(ViewTestCase):
    ...
    def test_response_200(self):
        "It should respond with 200."
        response = views.BlogTagListView.as_view()(self.request, blog_slug="my-blog")
        self.assertEqual(response.status_code, 200)

    def test_response_404_blog(self):
        "It should raise 404 if there's no Blog with that slug."
        with self.assertRaises(Http404):
            views.BlogTagListView.as_view()(self.request, blog_slug="other-blog")
...
class PostDetailViewTestCase(ViewTestCase):
    ...
    def test_templates_old(self):
        ...
        response = self.client.get("/terry/my-blog/2017/02/20/my-post/")
        self.assertEqual(
            response.template_name[0], "sets/2009/weblogs/post_detail.html"
        )
...
class PostRedirectViewTestCase(ViewTestCase):
    def setUp(self):
        ...
        self.blog = BlogFactory(slug="my-blog")
        LivePostFactory(
            blog=self.blog, time_published=make_datetime("2017-02-20 12:15:00")
        )

    def test_redirect(self):
        response = views.PostRedirectView.as_view()(
            self.request,
            blog_slug="my-blog",
            year=2017,
            month=2,
        ...
        self.assertEqual(response.url, "/terry/my-blog/2017/02/20/my-old-post/")
...
class PostDayArchiveViewTestCase(ViewTestCase):
    ...
    def test_redirect(self):
        response = views.PostDayArchiveView.as_view()(
            self.request, blog_slug="my-blog", year=2017, month=2, day=20
        )
        self.assertEqual(response.status_code, 302)
...
class PostMonthArchiveViewTestCase(ViewTestCase):
    ...
    def test_response_200(self):
        "It should respond with 200."
        response = views.PostMonthArchiveView.as_view()(
            self.request, blog_slug="my-blog", year=2017, month=2
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_response_404_invalid_blog(self):
        ...
        with self.assertRaises(Http404):
            views.PostMonthArchiveView.as_view()(
                self.request, blog_slug="OTHER-BLOG", year=2017, month=2
            )
    ...
    def test_response_404_invalid_date(self):
        ...
        with self.assertRaises(Http404):
            views.PostMonthArchiveView.as_view()(
                self.request, blog_slug="my-blog", year=2017, month=3
            )

    def test_response_404_invalid_status(self):
        "It should raise 404 if there's no matching published post"
        DraftPostFactory(
            blog=self.blog, time_published=make_datetime("2017-03-01 12:15:00")
        )
        with self.assertRaises(Http404):
            views.PostMonthArchiveView.as_view()(
                self.request, blog_slug="my-blog", year=2017, month=3
    ...
    def test_templates(self):
        ...
        self.assertEqual(response.template_name[0], "weblogs/post_archive_month.html")
...
class PostYearArchiveViewTestCase(ViewTestCase):
    ...
    def test_response_200(self):
        "It should respond with 200."
        response = views.PostYearArchiveView.as_view()(
            self.request, blog_slug="my-blog", year=2017
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_response_404_invalid_blog(self):
        ...
        with self.assertRaises(Http404):
            views.PostYearArchiveView.as_view()(
                self.request, blog_slug="OTHER-BLOG", year=2017
            )
    ...
    def test_response_404_invalid_date(self):
        ...
        with self.assertRaises(Http404):
            views.PostYearArchiveView.as_view()(
                self.request, blog_slug="my-blog", year=2016
            )

    def test_response_404_invalid_status(self):
        "It should raise 404 if there's no matching published post"
        DraftPostFactory(
            blog=self.blog, time_published=make_datetime("2016-01-01 12:15:00")
        )
        with self.assertRaises(Http404):
            views.PostYearArchiveView.as_view()(
                self.request, blog_slug="my-blog", year=2016
    ...
    def test_templates(self):
        ...
        self.assertEqual(response.template_name[0], "weblogs/post_archive_year.html")
...
class RandomPhilViewTestCase(ViewTestCase):
    def test_templates_default(self):
        ...
        self.assertEqual(
            response.template_name[0], "sets/2001/weblogs/random_phil.html"
        )
    ...
    def test_templates_2002(self):
        ...
        self.assertEqual(
            response.template_name[0], "sets/2002/weblogs/random_phil.html"
        )
