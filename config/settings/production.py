...
HINES_COMMENTS_ADMIN_NOT_PUBLISHED_FEED_SLUG = get_env_variable(
    "HINES_COMMENTS_ADMIN_NOT_PUBLISHED_FEED_SLUG"
)

HINES_COMMENTS_ADMIN_PUBLISHED_FEED_SLUG = get_env_variable(
    "HINES_COMMENTS_ADMIN_PUBLISHED_FEED_SLUG"
)
