...
INCOMING_WEBMENTIONS_ALLOWED = getattr(
    settings, "HINES_INCOMING_WEBMENTIONS_ALLOWED", False
)

OUTGOING_WEBMENTIONS_ALLOWED = getattr(
    settings, "HINES_OUTGOING_WEBMENTIONS_ALLOWED", False
)

AUTO_APPROVE_INCOMING_WEBMENTIONS = getattr(
    settings, "HINES_AUTO_APPROVE_INCOMING_WEBMENTIONS", False
)
